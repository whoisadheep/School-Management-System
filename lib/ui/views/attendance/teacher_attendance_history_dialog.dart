...
class TeacherAttendanceHistoryDialog extends ConsumerStatefulWidget {
  final Staff staff;

  const TeacherAttendanceHistoryDialog({super.key, required this.staff});

  @override
  ConsumerState<TeacherAttendanceHistoryDialog> createState() => _TeacherAttendanceHistoryDialogState();
}

class _TeacherAttendanceHistoryDialogState extends ConsumerState<TeacherAttendanceHistoryDialog> with SingleTickerProviderStateMixin {
        ...
        return StatefulBuilder(
          builder: (context, setDialogState) {
            return AlertDialog(
              ...
              title: Text('Edit Staff Attendance - ${record.date.substring(0, 10)}', style: GoogleFonts.poppins(color: AppTheme.textPrimary)),
              ...
              actions: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    await ref.read(databaseServiceProvider).updateTeacherAttendanceRecord(updatedRecord);
                    if (context.mounted) {
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Text(
                  'Attendance History - ${widget.staff.firstName} ${widget.staff.lastName}',
  ...
  Widget _buildMonthView() {
    return Column(
      children: [
        ...
        const SizedBox(height: 16),
        FutureBuilder<List<TeacherAttendance>>(
          future: ref.read(databaseServiceProvider).getAttendanceForStaff(
            widget.staff.id,
